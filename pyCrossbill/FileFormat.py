...
def FASTAFile(sequence, LOCUS, DEFINITION, ORGANISM, VERSION, file_Path):
...
path = 'A:/Bioinformatics/pyCrossbill/docs/samples/dengu3_strain-D00-0107.txt'
sequence = fromTXTfile(path)
print(fromTXTfile(path))
